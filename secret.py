...
The hard way is to create a .env file and store the values in there. For example, for the Genius access token you'd enter GENIUS_ACCESS_TOKEN=ex@mple in the .env file.
(RECOMMENDED) The easy way is to replace the default values below with the corresponding values. For example, for the Genius access token you'd replace ex@ample with the actual token.
"""
